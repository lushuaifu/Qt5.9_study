...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(864, 503);//设置主窗体大小
        QFont font;//创建字体类对象font
        font.setPointSize(11);//设置字体大小
        MainWindow->setFont(font);//设置主应用窗体字体大小
        actOpenDB = new QAction(MainWindow);//在主窗体上创建QAction对象
        actOpenDB->setObjectName(QStringLiteral("actOpenDB"));
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/images/open3.bmp"), QSize(), QIcon::Normal, QIcon::Off);//从图像文件中向 QIcon对象添加图像
        /*
         1）filename：文件名。
       ...
       */
        ...
        horizontalSpacer_3 = new QSpacerItem(45, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);//QSpacerItem类为布局提供了一个空白区
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actOpenDB->setToolTip(QApplication::translate("MainWindow", "\346\211\223\345\274\200\346\225\260\346\215\256\345\272\223", Q_NULLPTR));//setToolTip函数,可以给action指定一个工具提示内容
#endif // QT_NO_TOOLTIP
